"""
Ablation Study 4: Poison Rate 변화 (CIFAR-100)
==================================================
...
from config import (
    ...
    ABLATION_POISON_RATE_VALUES, NUM_WORKERS,
)
...
def main():
    ...
    acquire_lock(f"{DATASET_NAME}_poison_rate_ablation")

    device = DEVICE if torch.cuda.is_available() else "cpu"

    # 저장 경로 (poison_rate값마다 즉시 덮어쓰기 저장하여 중단 시에도 결과 보존)
